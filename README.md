...
`I enjoy the simple things in life—savoring small moments, using minimalist software, and believing that many things can be easier and simpler.`



My Stack
```
.java (Whole Spring ecosystem, jakarta, hibernate, and more...)
.c 
.go 
.lua
